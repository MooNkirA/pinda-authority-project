package com.moon.pinda.log.aspect;
...
import com.moon.pinda.log.event.SysLogEvent;
import com.moon.pinda.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.moon.pinda.log.annotation.SysLog)")
